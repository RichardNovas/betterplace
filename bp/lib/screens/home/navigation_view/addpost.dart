...
class MapOne extends StatefulWidget {
  MapOne({@required this.title, this.toggleView});
  final Function toggleView;

  final String title;

  @override
  State<MapOne> createState() => MapOneState();
}

class MapOneState extends State<MapOne> {
                ...
                child: Scaffold(
                    ...
                    body: SingleChildScrollView(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text('Contributing',style: TextStyle(color: Colors.white))),
                                                ),
                                              ),
                                              SizedBox(height: 10,),
                                              Card(
          ...
          Padding(padding: EdgeInsets.only(left:31),
           ...
           child:Align(
             alignment: Alignment.topRight,
              ...
              label: Row(
      children: <Widget>[Text('Show Requests',style: TextStyle(color: Colors.white,fontSize: 13),), ],
    ),
